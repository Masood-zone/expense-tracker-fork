...
import eyesOpened from "../assets/svg/eyes-open.svg";
import eyesClosed from "../assets/svg/eyes-close.svg";
          ...
          <div key={input.label}>
            <div className="flex flex-col my-1">
              ...
              <input
                ...
                className={`p-3 text-white border   bg-slate-300 w-80 h-10 mt-2 rounded-full ${
